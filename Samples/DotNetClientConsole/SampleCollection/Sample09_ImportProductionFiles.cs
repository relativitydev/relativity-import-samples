...
namespace Relativity.Import.Samples.DotNetClient.SampleCollection
{
	...
	public partial class ImportServiceSample
	{
		...
		{
			Console.WriteLine($"Running {nameof(this.Sample09_ImportProductionFiles)}");
			...
			const string opticonFilePath = "\\\\files\\T001\\StructuredData\\Import\\SampleDataSources\\opticon_02.opt";
